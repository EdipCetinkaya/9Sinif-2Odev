...
**Cevap:**    Defterdeki doğrunun eğimi 21.008 N/m
...
**Cevap:**  Y = 21.008 x + 0.275

c) Elle çizdiğiniz grafik orijinden geçmiyor.  *x=0* iken *y=0* değil. *x=0* iken *y* nedir? Sizce neden orjinden geçmiyor?
**Cevap:**  Deney tam olarak bilimsel bir deney değildi. Deney için kullanılan yay vb. Ölçüm aletlerinden kaynaklandığını düşünüyorum 
...
**Cevap**:   Nasıl resim ekleyeceğimi bilmiyorum
...
6. Grafiği defterinize çiziniz.Sonra size verdiğim google sheet örneğini kullanarak bilgisayar ile grafiği çiziniz. Değerler yakın mı? Google sheet dosyasının bağlantısını ver. [buraya bağlantı ver](   ). 
 Bilgisayarım yok fakat defterdeki değerler ile çok benzer sonuçlara vardım 
